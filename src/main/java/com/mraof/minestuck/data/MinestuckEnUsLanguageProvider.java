...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSBlocks.WHITE_CASTLE_BRICKS, "White Castle Bricks");
		add(MSBlocks.BLACK_CASTLE_BRICK_SMOOTH, "Smooth Black Castle Brick");
		add(MSBlocks.DARK_GRAY_CASTLE_BRICK_SMOOTH, "Smooth Dark Gray Castle Brick");
		add(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SMOOTH, "Smooth Light Gray Black Castle Brick");
		add(MSBlocks.WHITE_CASTLE_BRICK_SMOOTH, "Smooth White Castle Brick");
		add(MSBlocks.BLACK_CASTLE_BRICK_TRIM, "Black Castle Brick Trim");
		...
		add(MSItems.GUMBRAWLLERS_GAKURAN_HAT, "Gumbrawllers Gakuran Hat");
		add(MSItems.GUMBRAWLLERS_GAKURAN_JACKET, "Gumbrawllers Gakuran Jacket");
		add(MSItems.GUMBRAWLLERS_GAKURAN_PANTS, "Gumbrawllers Gakuran Pants");
		add(MSItems.GUMBRAWLLERS_GAKURAN_SHOES, "Gumbrawllers Gakuran Shoes");
		...
		add(MSItems.HEAVY_METAL_HELMET, "Heavy Metal Helmet");
		add(MSItems.HEAVY_METAL_CHESTPLATE, "Heavy Metal Chestplate");
		add(MSItems.HEAVY_METAL_LEGGINGS, "Heavy Metal Leggings");
		add(MSItems.HEAVY_METAL_BOOTS, "Heavy Metal Boots");
		...
		add(MSItems.BLACK_SUIT_JACKET, "Black Suit Jacket");
		add(MSItems.BLACK_SUIT_PANTS, "Black Suit Pants");
		add(MSItems.WHITE_SUIT_JACKET, "White Suit Jacket");
		add(MSItems.WHITE_SUIT_PANTS, "White Suit Pants");
		add(MSItems.BLACK_DRESS_SHOES, "Black Dress Shoes");
		add(MSItems.SLIMER_SUIT_JACKET, "Slimer Suit Jacket");
		add(MSItems.SLIMER_SUIT_PANTS, "Slimer Suit Pants");
		add(MSItems.JUNIOR_ECTOBIOLOGISTS_LAB_SUIT_JACKET, "Junior Ectobiologists Lab Suit Jacket");
		add(MSItems.JUNIOR_ECTOBIOLOGISTS_LAB_SUIT_PANTS, "Junior Ectobiologists Lab Suit Pants");
		add(MSItems.JUNIOR_ECTOBIOLOGISTS_LAB_SUIT_SHOES, "Junior Ectobiologists Lab Suit Shoes");
		...
		addStore(MSItems.ROCK_COOKIE, "Gray-Colored Cookie");
